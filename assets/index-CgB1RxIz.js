(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();document.addEventListener("DOMContentLoaded",()=>{m(),u(),g(),f(),h(),v(),y(),L()});function m(){const t=document.getElementById("typewriter");if(!t)return;const e=["Event-Driven Microservices.","Agentic AI & AI-Native Applications.","High-Throughput Kafka & Redis Architecture.","Scalable Cloud Systems on Azure & Kubernetes."];let s=0,i=0,n=!1,o=70;function r(){const a=e[s];n?(t.textContent=a.substring(0,i-1),i--,o=35):(t.textContent=a.substring(0,i+1),i++,o=70),!n&&i===a.length?(n=!0,o=2e3):n&&i===0&&(n=!1,s=(s+1)%e.length,o=500),setTimeout(r,o)}r()}function u(){const t=document.getElementById("terminal-input"),e=document.getElementById("terminal-screen"),s=document.getElementById("cli-clear-btn"),i=document.querySelectorAll(".cmd-chip"),n=document.getElementById("terminal-trigger");if(!t||!e)return;n&&n.addEventListener("click",()=>{const r=document.getElementById("terminal-section");r&&(r.scrollIntoView({behavior:"smooth"}),setTimeout(()=>t.focus(),500))}),t.addEventListener("keydown",r=>{if(r.key==="Enter"){const a=t.value.trim().toLowerCase();a&&(o(a),t.value="")}}),i.forEach(r=>{r.addEventListener("click",()=>{const a=r.getAttribute("data-cmd");o(a)})}),s&&s.addEventListener("click",()=>{e.innerHTML=`
