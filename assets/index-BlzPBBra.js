(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();document.addEventListener("DOMContentLoaded",()=>{p(),g(),u(),h(),f(),v(),y(),b()});function p(){const t=document.getElementById("typewriter");if(!t)return;const e=["Event-Driven Microservices.","Agentic AI & AI-Native Applications.","High-Throughput Kafka & Redis Architecture.","Scalable Cloud Systems on Azure & Kubernetes."];let s=0,o=0,n=!1,i=70;function a(){const r=e[s];n?(t.textContent=r.substring(0,o-1),o--,i=35):(t.textContent=r.substring(0,o+1),o++,i=70),!n&&o===r.length?(n=!0,i=2e3):n&&o===0&&(n=!1,s=(s+1)%e.length,i=500),setTimeout(a,i)}a()}function g(){const t=document.getElementById("terminal-input"),e=document.getElementById("terminal-screen"),s=document.getElementById("cli-clear-btn"),o=document.querySelectorAll(".cmd-chip"),n=document.getElementById("terminal-trigger");if(!t||!e)return;n&&n.addEventListener("click",()=>{const a=document.getElementById("terminal-section");a&&(a.scrollIntoView({behavior:"smooth"}),setTimeout(()=>t.focus(),500))}),t.addEventListener("keydown",a=>{if(a.key==="Enter"){const r=t.value.trim().toLowerCase();r&&(i(r),t.value="")}}),o.forEach(a=>{a.addEventListener("click",()=>{const r=a.getAttribute("data-cmd");i(r)})}),s&&s.addEventListener("click",()=>{e.innerHTML=`
      ...
      `});function i(a){const r=document.createElement("div");r.className="terminal-output-line",r.innerHTML=`<span class="prompt-user">guest@pankaj.dev:~$</span> <span class="cmd-text">${d(a)}</span>`,e.appendChild(r);const l=document.createElement("div");l.className="terminal-response";let c="";switch(a){case"help":c=`
        ...
        `;break;case"github":window.open("https://github.com/tacquire/","_blank"),c='<p>🔗 Opening <a href="https://github.com/tacquire/" target="_blank" style="color:var(--primary)">https://github.com/tacquire/</a> in a new tab...</p>';break;default:c=`<p>❌ Command not recognized: <span style="color:#ff5f56">'${d(a)}'</span>. Type <span class="highlight-cmd">'help'</span> for list of commands.</p>`;break}l.innerHTML=c,e.appendChild(l),e.scrollTop=e.scrollHeight}}function d(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function u(){const t=document.querySelectorAll(".filter-btn"),e=document.querySelectorAll(".skill-card");t.length&&t.forEach(s=>{s.addEventListener("click",()=>{t.forEach(n=>n.classList.remove("active")),s.classList.add("active");const o=s.getAttribute("data-filter");e.forEach(n=>{const i=n.getAttribute("data-category");o==="all"||i&&i.includes(o)?n.classList.remove("hidden"):n.classList.add("hidden")})})})}function h(){document.querySelectorAll(".copy-btn").forEach(e=>{e.addEventListener("click",()=>{const s=e.getAttribute("data-copy");s&&navigator.clipboard.writeText(s).then(()=>{m(`Copied to clipboard: ${s}`)}).catch(o=>{m("Failed to copy",!0)})})})}function m(t,e=!1){const s=document.getElementById("toast-container");if(!s)return;const o=document.createElement("div");o.className="toast",e&&(o.style.borderColor="#ff5f56"),o.innerHTML=`<i class="${e?"fa-solid fa-circle-exclamation":"fa-solid fa-circle-check"}" style="color:${e?"#ff5f56":"var(--accent)"}"></i> ${d(t)}`,s.appendChild(o),setTimeout(()=>{o.remove()},3e3)}window.handleContactSubmit=function(){const t=document.getElementById("contact-name").value.trim(),e=document.getElementById("contact-email").value.trim(),s=document.getElementById("contact-subject").value.trim(),n=`Hi Pankaj,

${document.getElementById("contact-message").value.trim()}

---
Sender Name: ${t}
Sender Email: ${e}`,i=`mailto:mishra.pankaj942@gmail.com?subject=${encodeURIComponent(s)}&body=${encodeURIComponent(n)}`;m("Opening your email client to send message to mishra.pankaj942@gmail.com..."),window.location.href=i,document.getElementById("contact-form").reset()};function f(){const t=document.getElementById("theme-toggle");if(!t)return;localStorage.getItem("theme")==="light"&&(document.documentElement.classList.remove("dark"),document.documentElement.classList.add("light"),t.innerHTML='<i class="fa-solid fa-sun"></i>'),t.addEventListener("click",()=>{document.documentElement.classList.contains("light")?(document.documentElement.classList.remove("light"),document.documentElement.classList.add("dark"),t.innerHTML='<i class="fa-solid fa-moon"></i>',localStorage.setItem("theme","dark")):(document.documentElement.classList.remove("dark"),document.documentElement.classList.add("light"),t.innerHTML='<i class="fa-solid fa-sun"></i>',localStorage.setItem("theme","light"))})}function v(){const t=document.getElementById("mobile-toggle"),e=document.getElementById("nav-links");!t||!e||(t.addEventListener("click",()=>{e.classList.toggle("active")}),document.querySelectorAll(".nav-link").forEach(s=>{s.addEventListener("click",()=>{e.classList.remove("active")})}))}function y(){const t=document.getElementById("resume-btn"),e=document.getElementById("resume-modal"),s=document.getElementById("close-modal-btn");!t||!e||(t.addEventListener("click",()=>{e.classList.add("active")}),s&&s.addEventListener("click",()=>{e.classList.remove("active")}),e.addEventListener("click",o=>{o.target===e&&e.classList.remove("active")}))}function b(){const t=document.querySelectorAll("section"),e=document.querySelectorAll(".nav-link");window.addEventListener("scroll",()=>{let s="";t.forEach(o=>{const n=o.offsetTop-100,i=o.clientHeight;window.scrollY>=n&&window.scrollY<n+i&&(s=o.getAttribute("id"))}),e.forEach(o=>{o.classList.remove("active"),o.getAttribute("href")===`#${s}`&&o.classList.add("active")})})}
